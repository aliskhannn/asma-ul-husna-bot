...
(
    ...
    current_question_num smallint NOT NULL DEFAULT 1,
    correct_answers      smallint          DEFAULT 0,
    total_questions      smallint NOT NULL,
    quiz_mode            varchar(20),                                                                                       -- "new", "review", "mixed"
    session_status       varchar(15)       DEFAULT 'active' CHECK ( session_status IN ('active', 'completed', 'abandoned')),-- "active", "completed", "abandoned"
